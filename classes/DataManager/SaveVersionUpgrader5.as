package classes.DataManager 
{
	...
	public class SaveVersionUpgrader5 implements ISaveVersionUpgrader 
	{
		...
		public function upgrade(data:Object):Boolean
		{
			...
			{
				kGAMECLASS.conLog("Upgrading to V5 " + k + "...");
		...
		public function verify(data:Object):Boolean
		{
			...
			{
				throw new VersionUpgraderError("Upgrader Version 5 recieved data version " + data.version + " during a verification call. Wakka wakka.");
				return false;
			}
