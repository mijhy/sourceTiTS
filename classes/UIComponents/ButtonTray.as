package classes.UIComponents 
{
	...
	public class ButtonTray extends Sprite
	{
		 ...
		 */
		public function addButton(slot:int, caption:String = "", func:Function = null, arg:* = undefined, ttHeader:String = null, ttBody:String = null):void
		{
			if (slot <= 14)
			{
		 ...
		 */
		public function addItemButton(slot:int, name:String = "", quantity:int = 0, func:Function = null, arg:* = undefined, ttHeader:String = null, ttBody:String = null, ttComparison:String = null)
		{
			if (slot <= 14)
			{
		...
		public function addDisabledButton(slot:int, cap:String = "", ttHeader:String = null, ttBody:String = null):void
		{
			...
			_buttonData[slot].setData(cap, null, undefined, ttHeader, ttBody);
			CheckPages();
		}
